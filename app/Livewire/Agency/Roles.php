...
class Roles extends Component
{
    ...
    public function render()
    {
        ...
        $availablePermissions = [
            ...
            'sales.create' => 'إضافة عملية بيع',
            'sales.edit' => 'تعديل عملية بيع',
            'sales.delete' => 'حذف عملية بيع',
            'providers.view' => 'عرض المزودين',
            'providers.create' => 'إضافة مزود',
            'providers.edit' => 'تعديل مزود',
            'providers.delete' => 'حذف مزود',
            'intermediaries.view' => 'عرض الوسطاء',
            'intermediaries.create' => 'إضافة وسيط',
            'intermediaries.edit' => 'تعديل وسيط',
            'intermediaries.delete' => 'حذف وسيط',
            ...
            'service_types.view' => 'عرض أنواع الخدمات',
            'service_types.create' => 'إضافة نوع خدمة',
            'service_types.edit' => 'تعديل نوع خدمة',
            'service_types.delete' => 'حذف نوع خدمة',
        ];
