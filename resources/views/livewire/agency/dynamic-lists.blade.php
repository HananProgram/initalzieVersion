                                    ...
                                    <li class="flex justify-between items-center px-2">
                                        @if ($editingSubItemId === $sub->id)
                                            <form wire:submit.prevent="updateSubItem" class="flex items-center gap-2 w-full">
                                                ...
                                                <button type="submit"
                                                    class="text-white font-bold px-3 py-1.5 rounded-md text-xs transition duration-300 hover:shadow-lg"
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-center gap-2">
                                                <button wire:click="startEditSubItem({{ $sub->id }})"
                                                    class="text-primary-700 border border-primary-600 hover:bg-primary-50 px-3 py-1.5 rounded-md text-xs font-medium transition">
                                                    تعديل
                                                </button>
                                                @if (!$list->is_system)
