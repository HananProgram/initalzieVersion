        ...
        <div class="bg-white rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto flex flex-col items-center justify-center relative">
            ...
            <form wire:submit.prevent="{{ $editingRole ? 'updateRole' : 'addRole' }}" class="w-full">
                <div class="space-y-4">
                    ...
                    <div x-data="{ showPerms: false }">
                        <label class="block text-sm font-medium text-gray-700 mb-3">الصلاحيات</label>
                        <button type="button" @click="showPerms = !showPerms" class="mb-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 px-4 py-1 rounded transition">
                            <span x-text="showPerms ? 'إخفاء الصلاحيات' : 'عرض الصلاحيات'"></span>
                        </button>
                        <div x-show="showPerms" class="grid grid-cols-1 md:grid-cols-2 gap-4" style="display: none;">
