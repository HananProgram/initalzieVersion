<div>
    <div class="flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-none p-4 bg-gray-50">
            ...
            <div id="reportModal" class="fixed inset-0 bg-black/10 flex items-center justify-center hidden z-50 backdrop-blur-sm transition-all duration-300">
                <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md transform transition-all duration-300 scale-95 opacity-0"
                    id="modalContent">
                    <h3 class="text-xl font-bold text-emerald-700 mb-4 text-center">اختر نوع التقرير</h3>
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <button type="button" onclick="generateFullReport()"
                            class="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 
                                text-white font-bold px-6 py-3 rounded-xl shadow-md hover:shadow-xl transition duration-300 text-sm">
                            تقرير كامل
                        </button>
